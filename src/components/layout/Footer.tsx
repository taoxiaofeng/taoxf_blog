        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/articles" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 transition-colors">
                  文章
                </Link>
              </li>
              <li>
                <Link to="/videos" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 transition-colors">
                  视频
                </Link>
              </li>
              <li>
